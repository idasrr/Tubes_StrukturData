...
void dataUser(ListUser &L){
    ...
    u = {"windi", "Windi Pramudya W.", "windipr@email.com", "Banten", "Premium", 19};
    P = alokasiUser(u);
    insertLastUser(L, P);

    u = {"ariel", "Ariel Furqanul Khaq", "arielf@email.com", "Bojongsoang", "Free", 20};
    P = alokasiUser(u);
    insertLastUser(L, P);

    u = {"arya", "Arya Wilson A.", "arya07@email.com", "BuahBatu", "Premium", 25};
    P = alokasiUser(u);
    insertLastUser(L, P);

    u = {"ida", "Ida Sri Rahayu", "idasrr@email.com", "Indonesia", "Premium", 19};
    P = alokasiUser(u);
    insertLastUser(L, P);

    u = {"jessie", "Jessie Marie C.", "jess@email.com", "Indonesia", "Free", 24};
    P = alokasiUser(u);
    insertLastUser(L, P);
}
